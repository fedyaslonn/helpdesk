from .views import UserViewSet, OrganizationViewSet, CommentViewSet
...
user_update_password = UserViewSet.as_view(
    {'post': 'update_password'}
)

user_set_organization = UserViewSet.as_view(
    {'post': 'set_organization'}
)

user_leave_organization = UserViewSet.as_view(
...
urlpatterns = [
    ...
    path('users/<int:pk>/update_password/',
        user_update_password,
        name='user-update-password'
    ),
    path('users/<int:pk>/set_organization/',
         user_set_organization,
         name='user-set-organization'),
    path('users/<int:pk>/leave_organization/',
         user_leave_organization,
         name='user-leave-organization'),
    path('organizations/organizations_list/', organization_list, name='organization-list'),
